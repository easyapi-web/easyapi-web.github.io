...
function nav() {
  return [
    ...
    { text: 'Q&A', link: '/qa/', activeMatch: '/qa/' },
    {
      text: 'Links',
      items: [
  ...
  return [
    {
      ...
      items: [
        ...
        { text: 'Custom Framework', link: '/framework/custom' },
  ...
  return [
    ...
    },
    {
      ...
      items: [
        ...
        { text: 'httpClient.request', link: '/settings/tools/httpClient/request' },
        { text: 'httpClient.response', link: '/settings/tools/httpClient/response' },
