...
Field context utilities for scripts. Provides helpers for working with JSON field paths in the context of field processing rules. Available **only in field rules**.
